...
The comprehensive overview of the research, with the contents of the folowing papers integrated, is given in [Jan Onderka's dissertation thesis](https://onderjan.net/dissertation_onderka.pdf).
...
Also see the [blogposts](https://machine-check.org/blog/) about **machine-check** and the [website](https://onderjan.net/) of the main developer.